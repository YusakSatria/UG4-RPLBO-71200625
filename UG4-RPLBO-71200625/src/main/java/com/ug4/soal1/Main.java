...
public class Main {
    ...
    private static void Pohon_Menu(Pohon pohon) {
        System.out.println("=========================================================================================");
        System.out.println("Pohon kehidupan");
    ...
    private static void Informasi_Pohon(Pohon pohon) {
        System.out.println("\n\n");
    ...
    private static void Inputan_Musim(Pohon pohon) {
        int hari = 0;
        System.out.println("\n\n");
    ...
    private static void Masa_Panen(Pohon pohon) {
        if (pohon.getMusim() != null) {
